# Project TODO
- [x] Implement PyTorch training, approval, and prediction domain controls.
- [x] Add success, validation, authorization, conflict, and unapproved model test coverage.
